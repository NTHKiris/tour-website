...
@section('content')
    <div class="w-[70%] mx-auto mt-[100px] mb-[60px]">
        <div class = "flex flex-row px-[15px]"> 
            <div style="background:url('/images/quynhonbanner.webp') center/cover; height:683px; with-full" class=" w-full md:w-1/2 h-[400px] relative  flex flex-wrap justify-end content-end items-end bg-[url('/images/quynhonbanner.webp')] bg-cover transition-all duration-300">
                        ...
                        <div class=" ">
                            <div class = "relative flex flex-col text-left items-start p-[40px]">
                                <div class = "flex text-left items-start mb-[15px]">
                                    <span>
                                        <i class="fa-solid fa-earth-africa fa-3x text-transparent" style="-webkit-text-stroke: 2px #000;"></i>
                                    </span>
                                </div>
                                <div class ="text-left  ">
                                    <h3 class = "text-[25px] font-normal leading-[36px] text-white ">Khám phá vẻ đẹp hoang xơ Quy Nhơn.</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class ="w-7/10">
                            <div class = "text-left mb-[30px]">
                                <h2 class = "text-[18px] font-[jost] leading-[28px] text-black mb-[10px]">Quy Nhon Tour là cổng thông tin đặt tour du lịch toàn cầu, nơi bạn có thể dễ dàng đặt các tour du lịch trong ngày, khởi hành theo nhóm cố định, kỳ nghỉ và các gói kỳ nghỉ tại Quy Nhơn, một trong những điểm đến hấp dẫn tại Việt Nam.</h2>
                                <p>Ngày nay, việc đặt tour du lịch hoặc gói kỳ nghỉ phù hợp đã trở thành một quá trình tốn thời gian và đau đầu. Nhà điều hành tour nào đủ điều kiện? Giá tour hợp lý là bao nhiêu? Khi bạn đặt cọc trước cho một nhà điều hành tour không rõ ràng, liệu tiền của bạn có an toàn không? Liệu những đánh giá trên trang web của nhà điều hành địa phương có chân thực không?</p>
                            </div>
                        </div>
                    </div>
                    <div class="ml-[110px] text-left ">
                        <a href="#" class = "text-[var(--accent)] border border-[var(--accent)] bg-transparent relative leading-[1.71] inline-block text-[14px] font-semibold rounded-[3px] cursor-pointer px-[27px] py-[11px] capitalize transition-all duration-300 ease-in-out appearance-none">
                            <span class = "flex flex-row">
                                <span class = "text-center">Liên hệ</span>
                                <span class = "text-center ml-[10px]"><i class="fa-solid fa-arrow-right-long text-sky-500"></i></span>
                            </span>
                        </a>
                    </div>
                </div>
        ...
        <div class="flex flex-row">
            <div class="w-full md:w-1/2 lg:w-1/4 px-[15px]">
                <div class="border-r-2 border-gray-500 flex text-left items-center">
                    <div class = "inline-block mr-[20px]">
                        <span>
                            <i class="fa-solid fa-bag-shopping text-[50px] text-transparent" style="-webkit-text-stroke: 2px #1e90ff;"></i>
                        </span>
                    </div>
                    <div>
                        ...
                        <p class="text-black text-[12px] font-semibold uppercase leading-[16px] m-0">Tour và ngày lễ</p>
                    </div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/4 px-[15px]">
                <div class="border-r-2 border-gray-500 flex text-left items-center">
                    ...
                    <div>
                        ...
                        <p class="text-black text-[12px] font-semibold uppercase leading-[16px] m-0">Đánhh giá chuyến đi</p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-[15px]">
                <div class="border-r-2 border-gray-500 flex text-left items-center">
                    <div class = "inline-block mr-[20px]">
                        <span>
                            <i class="fa-solid fa-earth-americas text-[50px] text-transparent" style="-webkit-text-stroke:2px #1e90ff;"></i>    
                        </span>
                    </div>
                    <div>
                        <h3 class="font-[jost] text-[24px] font-semibold leading-[24px] mb-[10px] text-sky-500">
                        ...
                        <p class="text-black text-[12px] font-semibold uppercase leading-[16px] m-0">Những nơi</p>
                    </div>
                </div>
            </div>
            ...
            @for($i = 1; $i <= 6; $i++)
                <div class="w-1/3 p-2 ">
                    <div class="mb-[50px]">
                        ...
                        <div class="text-[16px] leading-[1.375] font-normal text-[var(--text)] font-[Jost] w-full">
        ...
        <div class="flex flex-wrap">
            @for($i = 1; $i <= 4; $i++)
                <div class="w-1/4 px-[15px] text-center flex flex-col">
                    <div class="mb-[30px]">
                        <img src="/images/Eo-Gio.jpg" alt="" class="w-full h-[200px] object-cover">
                    </div>
                    <div class="pb-[5px] text-[20px] text-gray-700 font-semibold">
                        <span>Biển</span>
                    </div>
                    <div class="pb-[25px]">
                        <span class="text-sky-500 italic">Địa Danh</span>
                    </div>
                </div>
            @endfor
        </div>
        ...
        <div class="single-item">
            @for($review = 1; $review <= 4; $review++)
                <div class="text-center p-4  rounded">
                    <div class="text-gray-700 mb-[30px] text-[24px] leading-1.5 font-[Jost] font-semibold italic">
