...
<section class="py-16 bg-gradient-to-br from-slate-50 to-slate-200 min-h-[80vh]">
        ...
        <div class="grid lg:grid-cols-2 ">
            <div class="max-w-lg">
                ...
                <button class="group relative overflow-hidden rounded-lg py-4 font-medium transition-all duration-350 text-[16px] px-8 bg-cyan-500 text-white hover:text-black-900 flex justify-center items-center gap-2 hover:text-cyan-500 ">
            ...
            <div class="grid grid-cols-2 grid-rows-2 gap-4 h-[500px]">
                <div class="row-span-2 rounded-3xl overflow-hidden shadow-2xl border-4 border-cyan-600">
                    <img src="{{$image2}}" alt="" class="w-full h-full object-cover">
                </div>
                <div class="rounded-3xl overflow-hidden shadow-2xl border-4 border-cyan-600">
