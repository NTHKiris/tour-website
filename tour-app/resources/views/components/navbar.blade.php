            ...
            <div class="hidden md:flex space-x-3">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}"
                        class="px-4 py-2 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:border-cyan-500 hover:text-cyan-500 transition-all duration-300">
                        Đăng ký
                    </a>
                    <a href="{{ route('login') }}"
                        class="px-6 py-2 bg-cyan-500 text-white rounded-lg font-medium hover:bg-cyan-600 hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:shadow-cyan-500/25">
                        Đăng nhập
                    </a>
                @endauth
            </div>
            ...
            <div class="space-y-2">
                ...
                @else
                    <div class="border-t border-gray-200 pt-2 mt-2 space-y-2">
                        <a href="{{ route('register') }}"
                            class="block px-4 py-2 border-2 border-gray-300 text-gray-700 rounded-lg font-medium text-center hover:border-cyan-500 hover:text-cyan-500 transition-all duration-300">
                            Đăng ký
                        </a>
                        <a href="{{ route('login') }}"
                            class="block px-4 py-2 bg-cyan-500 text-white rounded-lg font-medium text-center hover:bg-cyan-600 transition-all duration-300">
                            Đăng nhập
                        </a>
                    </div>
                @endauth
